...
public class Camera2BasicFragment extends Fragment
     ...
     */
    private GetterClass getterClass;
...
//            openCamera(width,height);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getterClass =  ViewModelProviders.of((FragmentActivity) Objects.requireNonNull(getActivity())).get(GetterClass.class);
...
//                String pictureUrl  = FileUtils.saveImage(mTextureView.getBitmap(),getActivity(),mCurrentCameraId);
                ...
                intent.putExtra(ImageActivity.INTENT_DATA,filePath);
                Log.i("In Fragment", "" + name);
